...
For using Linux tools (Diamond, Tome, CheckM2) on Windows via WSL
"""
...
class WSLConfig(Config):
    """WSL environment specific configuration class"""
    ...
    def check_wsl_tools(self) -> dict:
        """Check availability of tools in WSL"""
        tools_status = {}
    ...
    def setup_wsl_environment(self):
        """Setup WSL environment variables and paths"""
        # Add special settings for WSL environment here
