        ...
        return {
            ...
            'databases': {
                ...
                'methane_pathways': {
                    ...
                    '甘氨酸甜菜碱产甲烷': 'methane/processed_甘氨酸甜菜碱产甲烷.fasta',
                    '硫代丙酸甲酯产甲烷': 'methane/processed_硫代丙酸甲酯产甲烷.fasta',
                    '四甲基铵产甲烷': 'methane/processed_四甲基铵产甲烷.fasta',
                    '甲醇歧化产甲烷': 'methane/processed_甲醇歧化产甲烷.fasta'
                },
                'sulfur_pathways': {
                ...
                'cultivation_pathways': {
                    'amino_acid': 'cultivation/amino_acid',
                    'vitamin': 'cultivation/vitamin',
                    'nucleotide': 'cultivation/nucleotide',
                    'atp': 'cultivation/atp'
                }
            },
            'pathway_names': {
                ...
                '2JIAAN-CH4': '二甲胺产甲烷途径',
                '3JIAAN-CH4': '三甲胺产甲烷途径',
                '甘氨酸甜菜碱产甲烷': '甘氨酸甜菜碱产甲烷途径',
                '硫代丙酸甲酯产甲烷': '硫代丙酸甲酯产甲烷途径',
                '四甲基铵产甲烷': '四甲基铵产甲烷途径',
                '甲醇歧化产甲烷': '甲醇歧化产甲烷途径',
                # Sulfur pathways
                'ASR': '同化型硫酸盐还原途径',
